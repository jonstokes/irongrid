Feature: Create Retail Listings
  ...
  Scenario:
    ...
    When I run CreateLinksWorker for test-site.com
    ...
    Then PageQueue should have 10 pages
    ...
    When I empty the ImageSet for test-site.com with DownloadResizeWorker for test-site.com
  ...
  Scenario:
    ...
    When I empty the PageQueue with ParsePagesWorker
    Then ParsedPageQueue should have 10 pages
