...
describe ProductDetails::ScrubMetadataSourceAttributes do
  describe "#perform" do
    it "scrubs the listing title" do
      ...
      result = ProductDetails::ScrubMetadataSourceAttributes.perform(title: title, keywords: keywords, category1: "Ammunition")
